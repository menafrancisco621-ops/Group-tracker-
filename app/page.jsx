...
function Avatar({ person, size = 56, busy, onPick }) {
  return (
    <label
    ...
    >
      ...
      {person.photo ? (
        ...
        <span
          className="flex h-full w-full items-center justify-center rounded-full border border-dashed border-neutral-300 bg-neutral-50 font-mono text-neutral-400"
          ...
          {!selfDone ? (
            ...
            <>
              {selfDone.person.photo ? (
                ...
                <div className="mx-auto flex h-24 w-24 items-center justify-center rounded-full bg-neutral-900 font-mono text-2xl text-white">
                  ...
                  >
                    <span className="relative">
                      {x.photo ? (
                        ...
                        <span
                          className={`flex h-32 w-32 items-center justify-center rounded-full font-mono text-2xl ${
                            inRoom
