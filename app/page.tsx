        ...
        <div className="mx-auto max-w-5xl p-4 md:p-8">
          ...
          {view === "week" && (
            <>
              ...
              {scanned && (
                <div className="mb-4 flex items-center justify-between gap-3 rounded-xl border border-neutral-900 bg-neutral-900 px-4 py-3 text-white">
                  <span className="text-sm">
                    <span className="font-semibold">{scanned}</span> · week of {label(week)}
                  </span>
                  <button
                    onClick={() => {
                      setScanned(null);
