          ...
          {all.length === 0 ? (
            ...
            <ul className="overflow-hidden rounded-xl border border-neutral-200 bg-white">
              {list.map((x) => (
                <li
                  key={x.id}
                  className="flex items-center justify-between gap-3 border-t border-neutral-100 px-3 py-2.5 first:border-t-0"
                >
                  <Avatar
                    person={x}
                    size={36}
                  ...
                  >
                    <span className="relative">
                      {x.photo ? (
                        ...
                        <span
                          className={`flex h-28 w-28 items-center justify-center rounded-full font-mono text-2xl ${
                            inRoom
